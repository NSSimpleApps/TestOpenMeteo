//
//  OpenMeteoImageDownloader.swift
//  TestOpenMeteo
//
...
protocol OpenMeteoImageURLProtocol: AnyObject {
    var imageURL: URL? { get set }
}

/// Скачивание изображений по урлу.
@MainActor
final class OpenMeteoImageDownloader {
    ...
    func loadImageOn<ImageCell: OpenMeteoImageURLProtocol>(cell: ImageCell, imageURL: URL,
